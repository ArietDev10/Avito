...
class SubCategoryForCategorySerializer(serializers.ModelSerializer):
    class Meta:
        model = SubCategory
        fields = ['sub_category_name', 'sub_category_image']
...
class CategorySimbleSerializer(serializers.ModelSerializer):
    class Meta:
        model = Category
        fields = 'category_name', 'category_image'

class SubCategoryListSerializer(serializers.ModelSerializer):
    category = CategorySimbleSerializer()
    class Meta:
        model = SubCategory
...
class SubCategoryDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SubCategory
        fields = ['category','sub_category_name', 'sub_category_image', 'sub_product']
...
class ProductDetailSerializer(serializers.ModelSerializer):
    category_img = ProductImageSerializer(many=True, read_only=True)
    product_reviews = ReviewsSerializer(many=True, read_only=True)
    class Meta:
        model = Product
        fields = ['id', 'product_name','category_img', 'price', 'description',
                  'article_number', 'product_type', 'video','product_reviews','updated_date','created_date']
